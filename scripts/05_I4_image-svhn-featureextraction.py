...
digits = sio.loadmat(r'c:../datasets/svhn-test_32x32.mat')
...
# Image: 32 x 32 pixels, after resampling a digit of 0 is in 5th position
plt.imshow(X[4,:,:,:])
...
X_features = pd.DataFrame(columns=list(range(0, 144))) # number of featuresper la matriu sigui igual pel predictor 
