...
# model train 
neuralnet_model = MLPClassifier(alpha=1, max_iter=1000)
...
plot_decision_regions(X=X_combined, y=y_combined, classifier=neuralnet_model, test_idx=range(train_len, combined_len))
